...
class Remove_Employee implements ActionListener{
    JFrame f1;
    JTextField t;
    JLabel la1,la2,l2,l3,l4,l6,l7,l8;
    JButton b,b1,b2,b3;

    Remove_Employee(){
        f1=new JFrame("Remove Employee");
        f1.setBackground(Color.WHITE);   
        f1.setLayout(null);

        la1=new JLabel();
        la1.setBounds(0,0,500,500);
        la1.setLayout(null);
        ...
        la2=new JLabel("Employee Id");
        la2.setBounds(50,50,250,30);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b){
            try{
                conn con = new conn();
                String str = "select e_name,e_phone,e_email from employee where e_id ='"+t.getText()+"' ";
        ...
        if(ae.getSource()==b1){
            try{
                conn con = new conn();
                String str = "delete from employee where e_id = '"+t.getText()+"'";
